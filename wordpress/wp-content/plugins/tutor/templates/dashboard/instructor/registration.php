	...
	<form method="post" enctype="multipart/form-data">
		...
		<div class="tutor-form-col-6">
			<div class="tutor-form-group">
				...
				<input type="text" name="description" class="tutor_description" value="<?php echo esc_attr( tutor_utils()->input_old( 'description' ) ); ?>" placeholder="<?php esc_html_e( 'description', 'tutor' ); ?>" required autocomplete="description">
			</div>
		</div>
